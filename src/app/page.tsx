...
import { Github, Linkedin, Mail, Instagram, FileDown, ExternalLink } from "lucide-react";
            ...
            <div className="flex gap-8">
              {['about', 'skills', 'projects'].map((item) => (
                <motion.a
                  key={item}
                  href={`#${item}`}
                  className={`capitalize ${activeSection === item ? 'text-purple-400' : 'text-gray-400'} hover:text-purple-400 transition-colors`}
            ...
            <div className="flex flex-col md:flex-row items-center gap-16">
              ...
              >
                <div className="space-y-4">
                  ...
                  >
                    Software Engineer with 3 years of experience in crafting robust and scalable software systems.
                    Bridging the gap between front-end aesthetics and back-end functionality is my forte.
                  </motion.p>
                </div>
                ...
                >
                  {[
                    { icon: <Github size={24} />, link: "https://github.com/hemant10yadav" },
                    { icon: <Linkedin size={24} />, link: "https://www.linkedin.com/in/hemantyad" },
                    { icon: <Instagram size={24} />, link: "https://www.instagram.com/h.e.m.a.n.t.10" },
                    { icon: <Mail size={24} />, link: "mailto:hemant.10.yadav@gmail.com" }
                  ].map((social, index) => (
                    <motion.a
                      key={index}
                      href={social.link}
